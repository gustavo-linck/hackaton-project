...
public class PageService(AppDbContext db, IPlanLimitService limits, IAuditService audit) : IPageService
{
    ...
    public async Task<PageDto?> GetBySlugAsync(string slug)
    {
        ...
        return page is null ? null : ToDto(page, page.Links.Count);
    }
